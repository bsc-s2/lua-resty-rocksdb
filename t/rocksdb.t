...
--- response_body
open db success
failed to open db: CreateDbErr IO error: While lock file: ./t/servroot/fastcgi_temp/rocksdb_c_simple_example/LOCK: No locks available
failed to open db: CreateDbErr Invalid argument: ./t/servroot/fastcgi_temp/not_exist_dir_path: does not exist (create_if_missing is false)
